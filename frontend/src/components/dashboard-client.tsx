...
export function DashboardClient({
  ...
  const handleUpload = async () => {
    ...
    try {
      // Upload file through API endpoint instead of directly to S3
      ...
      toast.error("Upload failed", {
        description:
          error instanceof Error ? error.message : "There was a problem uploading your video. Please try again.",
      });
    } finally {
      setUploading(false);
    }
